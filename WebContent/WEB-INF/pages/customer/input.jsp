...
<body class="main">
	...
	<div class="button_bar">
		<button class="common_button" onclick="window.location.href='contact/list/${customer.id }'">
			联系人
		</button>
		<button class="common_button" onclick="window.location.href='activity/list/${customer.id }'">
			交往记录
		</button>
		<button class="common_button" onclick="window.location.href='order/list/${customer.id }'">
			历史订单
		</button>
