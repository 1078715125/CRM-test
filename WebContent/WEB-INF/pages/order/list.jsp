...
<html lang="true">
  ...
  <body>
  	<form action="order/list/${custId }" method="post" id="command">
  	</form>
			...
			<c:forEach var="order" items="${page.content }">
				<tr>
					...
					<td class="list_data_op">
						<img onclick="window.location.href='order/details/${order.id }'" 
						title="查看明细" src="static/images/bt_detail.gif" class="op_button" />
					</td>
				</tr>			
			</c:forEach>
		</table>
