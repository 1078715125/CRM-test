...
<script type="text/javascript">
	$(function(){
		$("img[id^='delete-']").click(function(){
			...
			var flag = confirm("确认要删除【"+name+"】这个名称的商品吗");
			if(!flag){
				return false;
			}
			var id = this.id.split("-")[1];
			var url = "product/create/"+id;
			$("#_method").val("DELETE");
...
<body>
	...
	<div class="button_bar">
		<button class="common_button" onclick="window.location.href='product/create'">
			产品添加
		</button>
	...
	<form action="product/list" method="post" id="command">
		<table class="query_form_table" border="0" cellPadding="3"
			...
			<tr>
				...
				<td>
					<input type="text" name="search_LIKES_batch" value="${LIKES_batch }"/>
				</td>
			</tr>
		</table>
		<!-- 列表数据 -->
		...
		<c:forEach var="product" items="${page.content }">
			<tr>
				...
				<td class="list_data_op">
					<img onclick="window.location.href='product/create/${product.id }'" 
