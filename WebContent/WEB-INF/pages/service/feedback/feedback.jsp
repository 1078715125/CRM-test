...
<body class="main">
	...
	<form action="service/feedback" method="post">
		...
		<table class="query_form_table">
			<tr>
				...
				<th>分配时间</th>
				<td><fmt:formatDate value="${service.allotDate }"
						pattern="yyyy-MM-dd" /></td>
			</tr>
		</table>
		...
		<table class="query_form_table">
			<tr>
				<th>服务处理</th>
				<td colspan="3">${service.serviceDeal}<span class="red_star">*</span>
				</td>
			</tr>
			<tr>
				<th>处理人</th>
				<td>
					<!-- 					<shiro:principal /> --> ${service.createdby.name } <span
					class="red_star">*</span>
				</td>
				<th>处理时间</th>
				<td><input
					value="<fmt:formatDate value="${service.dealDate }"
						pattern="yyyy-MM-dd" />"
					readonly="readonly" id="dealDate" /> <span class="red_star">*</span></td>
			</tr>
		</table>
		<br />
		...
		<table class="query_form_table">
			<tr>
				<th>处理结果</th>
				<td><input type="text" name="dealResult" /><span
