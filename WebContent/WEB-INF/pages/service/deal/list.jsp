...
<body>
	...
	<div class="button_bar">
		<button class="common_button"
			onclick="window.location.href='service/create';">新建</button>
		<button class="common_button" id="clear">清除条件</button>
		<button class="common_button" onclick="document.forms[1].submit();">
			查询</button>
	</div>

	<form action="service/deal" method="post" id="command">
				...
				<c:forEach var="service" items="${page.content }">
					<tr>
						...
						<td class="list_data_op"><img
							onclick="window.location.href='service/deal/${service.id}'"
							title="处理" src="static/images/bt_deal.gif"
							class="op_button" /></td>
					</tr>
				</c:forEach>
			</table>
