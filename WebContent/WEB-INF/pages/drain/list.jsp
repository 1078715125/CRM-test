...
<body>
	...
	<form action="drain/list" method="post" id ="command"> 
		<table class="query_form_table" border="0" cellPadding="3"
			...
			<tr>
				...
				<td>
					<input type="text" name="search_LIKES_managerName" value="${LIKES_managerName }"/>
				</td>
				<th>
					&nbsp;
				</th>
					...
					<tr>
						...
						<td class="list_data_op">
							<c:if test="${drain.status == '流失预警'}">
								<img onclick="window.location.href='drain/confirm?id=${drain.id }'" 
									title="确认流失" src="static/images/bt_confirm.gif" class="op_button" />
								<img onclick="window.location.href='drain/delay?id=${drain.id }'" 
									title="暂缓流失" src="static/images/bt_relay.gif" class="op_button" />
							</c:if>
						</td>
					</tr>
				</c:forEach>
