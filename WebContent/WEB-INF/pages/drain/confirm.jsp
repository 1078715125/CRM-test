...
<body class="main">
	...
	<div class="button_bar">
		...
		<button class="common_button" id="confirm">保存</button>
	</div>

	<form action="drain/confirm" method="post">
		...
		<table class="query_form_table" border="0" cellPadding="3"
			...
			<tr>
				<th>流失原因</th>
				<td colspan="3"><textarea name="reason" cols="50" rows="6" id="reason"></textarea>&nbsp;</td>
			</tr>
		</table>
	</form>
</body>
